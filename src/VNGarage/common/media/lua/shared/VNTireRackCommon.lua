...
function VNTireRackCommon.OnCreateRecipe(thumpable)
	VNTireRackCommon.SetupPlacedTile(thumpable)
end
...
for _, value in ipairs(tile_tags) do
	MapObjects.OnLoadWithSprite(value .. '_0', VNTireRackCommon.SetupPlacedTile, 5)
	MapObjects.OnLoadWithSprite(value .. '_1', VNTireRackCommon.SetupPlacedTile, 5)
	MapObjects.OnLoadWithSprite(value .. '_2', VNTireRackCommon.SetupPlacedTile, 5)
	MapObjects.OnLoadWithSprite(value .. '_3', VNTireRackCommon.SetupPlacedTile, 5)
end
